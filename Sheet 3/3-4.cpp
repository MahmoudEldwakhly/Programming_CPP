...
int main()
{
    int maxpower = 15000; // If we want more accurate results we make maxpower bigger
   float x,y ;
   int z;
   cout <<"choose number : angle in 1- degrees or 2- radian"<<endl;
   cin>>z;
   if (z==1)
   {
